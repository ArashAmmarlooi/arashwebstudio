...
export const pageTranslations: Record<Locale, PageTranslations> = {
  en: {
    ...
    footer: {
      description: "Arash Web Studio designs responsive websites, AI voice agents, IT help desk & networking, e-commerce, booking systems, mobile apps and custom software for businesses worldwide.",
      ...
      serviceTitles: { "ai-automation-agents": "AI Automation & Voice Agents", "it-support-networking": "IT Support, Networking & Systems", "ecommerce-web-design": "E-commerce Website Design", "booking-website-design": "Booking & Appointment Websites", "small-business-web-design": "Small & Medium Business Web Design", "mobile-app-design": "Mobile Application Design", "custom-software-development": "Custom Software Development", "brand-identity-design": "Brand & Visual Identity Design" },
    },
    home: {
      eyebrow: "Web · SEO · AI Automation · Software", title: "Digital experiences built for", titleAccent: "business growth.", intro: "Responsive web design, 24/7 AI voice agents and custom development for small and medium-sized businesses anywhere in the world. We create business websites, AI automation, IT & networking care, e-commerce stores, booking platforms, mobile apps and custom software.", primaryCta: "Start Your Project", secondaryCta: "About the Studio", imageAlt: "Responsive website design displayed on a phone and laptop", processEyebrow: "How it works", processTitle: "From strategy to measurable growth",
  ...
  es: {
    ...
    footer: { description: "Arash Web Studio diseña sitios adaptables, agentes de voz y automatización con IA, comercio electrónico, sistemas de reservas y software a medida para empresas de todo el mundo.", pages: "Páginas", services: "Servicios", getInTouch: "Contacto", location: "Estudio digital remoto", serviceArea: "Trabajamos con clientes de todo el mundo", copyright: "Diseño web y soluciones digitales para todo el mundo.", serviceTitles: { "ai-automation-agents": "Automatización IA & Agentes de Voz", "it-support-networking": "Soporte TI, redes y sistemas", "ecommerce-web-design": "Diseño de sitios de comercio electrónico", "booking-website-design": "Sitios de reservas y citas", "small-business-web-design": "Diseño web para pequeñas y medianas empresas", "mobile-app-design": "Diseño de aplicaciones móviles", "custom-software-development": "Desarrollo de software a medida", "brand-identity-design": "Diseño de marca e identidad visual" } },
  ...
  it: {
    ...
    footer: { description: "Arash Web Studio progetta siti responsive, agenti vocali e di automazione IA, e-commerce, sistemi di prenotazione, app mobili e software su misura per imprese in tutto il mondo.", pages: "Pagine", services: "Servizi", getInTouch: "Contatti", location: "Studio digitale da remoto", serviceArea: "Collaboriamo con clienti in tutto il mondo", copyright: "Web design e soluzioni digitali in tutto il mondo.", serviceTitles: { "ai-automation-agents": "Automazione IA & Agenti Vocali", "it-support-networking": "Supporto IT, reti e sistemi", "ecommerce-web-design": "Progettazione di siti e-commerce", "booking-website-design": "Siti per prenotazioni e appuntamenti", "small-business-web-design": "Web design per piccole e medie imprese", "mobile-app-design": "Progettazione di applicazioni mobili", "custom-software-development": "Sviluppo software su misura", "brand-identity-design": "Brand e identità visiva" } },
